 ...
 * On 2016/04/18 16:15
 */
public class YdVideoPlayerStandard extends YdVideoPlayer {

    protected static Timer DISMISS_CONTROL_VIEW_TIMER;
    protected static Timer DISMISS_TITLE_VIEW_TIMER;
    ...
    private ImageView maskTitleView;


    protected DismissControlViewTimerTask mDismissControlViewTimerTask;
    protected DismissTitleViewTimerTask mDismissTitleViewTimerTask;
    ...
    public YdVideoPlayerStandard(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setUp(Object[] dataSourceObjects, int defaultUrlMapIndex, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            if (((LinkedHashMap) dataSourceObjects[0]).size() == 1) {
                ...
                clarity.setText(YdMediaUtils.getKeyFromDataSource(dataSourceObjects, currentUrlMapIndex));
                clarity.setVisibility(View.VISIBLE);
            }
            changeStartButtonSize((int) getResources().getDimension(R.dimen.ydsdk_jz_start_button_w_h_fullscreen));
            ...
            tinyBackImageView.setVisibility(View.INVISIBLE);
            changeStartButtonSize((int) getResources().getDimension(R.dimen.ydsdk_jz_start_button_w_h_normal));
    ...
    public void onStatePlaying() {
        ...
        if (null != this.mOnStatusChangeListener) {
            this.mOnStatusChangeListener.onPlay();
        }
    }
    ...
    public void onStatePause() {
        ...
        if (null != this.mOnStatusChangeListener) {
            this.mOnStatusChangeListener.onPause();
        }
    }
    ...
    public void onStateError() {
        ...
        changeUiToError();
        if (null != this.mOnStatusChangeListener) {
            this.mOnStatusChangeListener.onError();
        }
    }
    ...
    public void onStateAutoComplete() {
        ...
        if (null != this.mOnStatusChangeListener) {
            this.mOnStatusChangeListener.onAutoComplete();
        }
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(YdUserActionStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                ...
                onEvent(YdUserActionStandard.ON_CLICK_START_THUMB);
                startVideo();
            ...
            if (YdVideoPlayerManager.getFirstFloor().currentScreen == YdVideoPlayer.SCREEN_WINDOW_LIST) {
            ...
            final LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.ydsdk_jz_layout_clarity, null);
            ...
            for (int j = 0; j < ((LinkedHashMap) dataSourceObjects[0]).size(); j++) {
                String key = YdMediaUtils.getKeyFromDataSource(dataSourceObjects, j);
                TextView clarityItem = (TextView) View.inflate(getContext(), R.layout.ydsdk_jz_layout_clarity_item, null);
            ...
            onStatePreparing();
            onEvent(YdUserAction.ON_CLICK_START_ERROR);
        }
    }
    ...
    public void showWifiDialog() {
        ...
        builder.setMessage(getResources().getString(R.string.ydsdk_tips_not_wifi));
        builder.setPositiveButton(getResources().getString(R.string.ydsdk_tips_not_wifi_confirm), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                onEvent(YdUserActionStandard.ON_CLICK_START_WIFIDIALOG);
                startVideo();
                WIFI_TIP_DIALOG_SHOWED = true;
            }
        });
        builder.setNegativeButton(getResources().getString(R.string.ydsdk_tips_not_wifi_cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                clearFloatScreen();
    ...
    public void showProgressDialog(float deltaX, String seekTime, long seekTimePosition, String totalTime, long totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.ydsdk_jz_dialog_progress, null);
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.ydsdk_jz_dialog_volume, null);
    ...
    public void showBrightnessDialog(int brightnessPercent) {
        ...
        if (mBrightnessDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.ydsdk_jz_dialog_brightness, null);
    ...
    public void setTitleMask(ImageView maskView) {
        this.maskTitleView = maskView;
        this.maskTitleView.setOnClickListener(new OnClickListener() {
    ...
    public void showTitle() {
        if (this.maskTitleView != null) {
            if (this.maskTitleView.getVisibility() == INVISIBLE) {
                this.startDismissTitleTimer();
            } else {
                this.maskTitleView.setVisibility(INVISIBLE);
                this.startDismissTitleTimer();
            }
        }
    }
    ...
    public void startDismissTitleTimer() {
        this.cancelTitleViewTimer();
        DISMISS_TITLE_VIEW_TIMER = new Timer();
        this.mDismissTitleViewTimerTask = new DismissTitleViewTimerTask();
        DISMISS_TITLE_VIEW_TIMER.schedule(this.mDismissTitleViewTimerTask, 3000L);
    }


    public void cancelTitleViewTimer() {
        if (DISMISS_TITLE_VIEW_TIMER != null) {
            DISMISS_TITLE_VIEW_TIMER.cancel();
        }

        if (this.mDismissTitleViewTimerTask != null) {
            this.mDismissTitleViewTimerTask.cancel();
        }

    }

    public class DismissTitleViewTimerTask extends TimerTask {
        public DismissTitleViewTimerTask() {
        }
        ...
        public void run() {
            if (getContext() != null && getContext() instanceof Activity) {
                ((Activity) getContext()).runOnUiThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        if (maskTitleView != null) {
                            if (currentState != CURRENT_STATE_PAUSE
                                    && currentState != CURRENT_STATE_ERROR
                                    && currentState != CURRENT_STATE_AUTO_COMPLETE) {
                                maskTitleView.setVisibility(VISIBLE);
                            } else {
                                maskTitleView.setVisibility(INVISIBLE);
                            }
                        }
    ...
    public void setAllControlsVisible(int topCon, int bottomCon,
                                      int startBtn, int loadingPro,
                                      int thumbImg, int errorCon, int bottomPro) {
        ...
        this.mRetryLayout.setVisibility(errorCon);
