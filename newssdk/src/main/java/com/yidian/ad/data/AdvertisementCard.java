...
import com.yidian.newssdk.data.card.base.CardDisplayInfo;
 ...
 */
@Entity
public class AdvertisementCard extends com.yidian.newssdk.data.card.base.Card  implements Serializable {
...
//    public int session = AdConstants.SPLASH_TYPE_DEFAULT;
    ...
    public boolean noAdTag = false; //目前template8，9会用到这个字段，需要隐藏广告标签
...
//    public String docId;
    ...
    public boolean isAutoplay = false;//template 19,用于说明是否进行自动轮播

    //template 11、111公用的活动的url，图标url和按钮名称
    public String huodongFormUrl = EMPTY_STRING;
    public String huodongIconUrl = EMPTY_STRING;
    public String huodongButtonName = EMPTY_STRING;
    //template 116配置”报名“的字段
    public String huodongButtonDesc = EMPTY_STRING;

    public String videoUrl = EMPTY_STRING;

    public long viewId = -1L;
...
//    template26、126 电话号码
    ...
    public int video_type = 0;//1:跳正文页，其他：跳h5
    public String shareImage;//搜索广告频道的分享图片
    public int button_type = 3;//拨打电话跳转类型。3：电话拨打页，0：跳h5
    private List<GalleryAdTagEntity> tags;
    public String backgroundImagePath;//背景图广告（template37）图片地址
    ...
    @Generated
    public AdvertisementCard(Long colId, long aid, String eid, String tid, String adsFrom, String ex, String clickMonitorUrlsStr, String viewMonitorUrlsStr, String dspName, String adMessage, int template, int externalApp, int showShare, int playSound, int reportEvent, int adDuration, String imageUrl, String localImageFilePath, int type, String clickUrl, String adChannelId, String adChannelName, String adChannelType, String adChannelImage, String docId, String deeplinkUrl, String hybridContentString, String net, String event, long time, String packageName, long downloadId, long expireTime, long startTime, int startAppStore, int position, int downloadStatus, int downloadProgress) {
        this.colId = colId;
        this.aid = aid;
        this.eid = eid;
        this.tid = tid;
...
//                }
    ...
    private static String getStringWithCheckNull(JSONObject json, String fieldName) {
...
//    }
    ...
    private static String[] parseJSONString(JSONArray array, boolean isAdMonitorUrl) {
