...
public class ThreadUtils {
    ...
    /**
     * uiThreadUtils
     * 如果在activity 调用，请在ondestroy
     * 调用cancel 会有内存泄漏，还有可能导致崩溃
     */
    ...
    public static boolean runningOnUI() {
    ...
    public static boolean postDelayed2Logic(Runnable r, long delayMillis) {
    ...
    public static void safeCheckUIThread(String log) {
        if (!runningOnUI() && LogUtils.isDebug()) {
